...
| 项 | 出处 | 状态 | 下一步 |
|----|------|------|--------|
| **人格设定（AI 拟人化：名字/语气）** | 主文档 §八#1、能力矩阵 §六、Phase1 构想（名字+固定语气：专业/直接/不废话/会提醒/中文/记忆人格）、架构分析 v2（阶段 0 给 3 个人格候选让 Vera 选） | ✅ 已实施（2026-08-14）：四种内置 + 默认 A | config/persona.yaml + core/persona.py + 接入角色层；V2 设置页切换 + 前端提示词 |

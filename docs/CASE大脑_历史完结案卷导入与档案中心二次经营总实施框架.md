...
| 批次 | 核心任务 | 施工单规划 | 前端提示词 |
| :--- | :--- | :--- | :--- |
| **批次一 (WO-60)** | **历史案卷批量入库管道与放款事实解析** | `wo-60-archive-batch-ingestion.md` | 档案中心：批量导入历史案卷弹窗与进度监控 |
| **批次二 (WO-61)** | **二次经营时钟引擎与主动商机看板** | `wo-61-retention-scheduler.md` | 档案中心：二次经营商机雷达看板（红黄绿预警） |
| **批次三 (WO-62)** | **AI 知识萃取与审批官/先例图谱** | `wo-62-knowledge-precedent-mining.md` | 知识中心：审批官画像卡片与实战先例检索面板 |
| **批次四 (WO-63)** | **档案中心全景重构与最终交付** | `wo-63-archive-hub-redesign.md` | 档案中心整体界面重构定稿与体验收口 |

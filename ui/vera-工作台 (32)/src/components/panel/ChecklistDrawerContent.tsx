...
export function ChecklistDrawerContent({ caseId }: ChecklistDrawerContentProps) {
  const { items, loading, error, fetchChecklist, toggleItem, reset } = useChecklistStore();
  ...
  if (error) {
    return (
      <div className="p-4 rounded-xl border border-red-500/30 bg-red-500/10 text-red-500 space-y-3" id="checklist-drawer-error">

    ...
    >
      <div className="flex items-center justify-between pb-2 border-b" style={{ borderColor: 'var(--border)' }}>
        <div className="flex items-center space-x-2 min-w-0">
          ...
          <span className="px-2 py-0.5 rounded text-[10px] font-mono font-bold bg-purple-500/10 text-purple-600 dark:text-purple-400 flex-shrink-0">
            {docType}
          </span>
        </div>
        {onPreviewClick && (
          ...
          return (
            ...
            >
              <div className="flex items-center justify-between text-[11px] text-muted">
                ...
                <span className={`font-mono text-[10px] ${isLowConf ? 'text-amber-600 font-bold' : 'text-emerald-500 font-semibold'}`}>
                  {confidence}%
                </span>
              </div>
              ...
              {isEditing ? (
                <div className="flex items-center space-x-1.5 pt-0.5">
                  <input
                    ...
                    autoFocus
                  />
                  <button onClick={() => saveEdit(idx)} className="p-1.5 rounded-lg bg-[var(--accent)] text-white cursor-pointer">
              ...
              {isLowConf && (
                <div className="flex items-center space-x-1 text-[10px] text-amber-600 dark:text-amber-400 font-semibold pt-0.5">

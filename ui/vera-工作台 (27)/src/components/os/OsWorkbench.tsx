...
export function OsWorkbench({ taskId, onClose }: OsWorkbenchProps) {
  ...
  const clientName = task?.caseName || 'PERSON_1';
    ...
    >
      ...
      >
        <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center space-x-3 text-xs">
            ...
            <div className="flex items-center space-x-2 text-[11px] font-mono text-muted">
              ...
              <span>•</span>
              <span className="px-2 py-0.5 rounded font-bold text-purple-600 bg-purple-500/10">
                {stage}
              </span>
            </div>
          </div>
        ...
        <div className="flex items-center space-x-2">
          <span className="px-2.5 py-1 rounded-lg text-xs font-mono font-bold flex items-center space-x-1 bg-rose-500/10 text-rose-500 border border-rose-500/20">

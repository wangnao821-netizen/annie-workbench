...
import { Plus, Briefcase, AlertCircle, RefreshCw, LayoutGrid, Kanban } from 'lucide-react';
...
export function CaseBoard({ onOpenCase }: CaseBoardProps) {
    ...
    <div className="flex-1 flex flex-col h-full overflow-hidden p-6 space-y-5" id="case-board-page">
      ...
      <div className="flex-1 overflow-y-auto no-scrollbar pt-1">
        {casesLoading && cases.length === 0 ? (
          ...
          <KanbanBoard cases={filteredCases} onCardClick={handleSelectCase} />
        ) : (
          <>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">

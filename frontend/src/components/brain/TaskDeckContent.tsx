              ...
              >
                ...
                <div className="flex items-center justify-between space-x-2 min-w-0">
                  <div className="flex items-center space-x-2 truncate flex-1 min-w-0">
                    ...
                    <span
                      className={`text-xs font-medium truncate cursor-pointer hover:text-[var(--accent)] transition-colors ${
                ...
                <div
                  className="flex items-center justify-end space-x-2 pt-1 border-t opacity-90 transition-opacity text-[11px]"
                  style={{ borderColor: 'var(--border)' }}
                >
                  {!task.completed && (
                    <button
                      ...
                      id={`deck-hover-complete-${task.id}`}
                    >
                  ...
                  <button
                    ...
                    id={`deck-hover-delegate-${task.id}`}
                  >
                  ...
                  <button
                    ...
                    id={`deck-hover-deadline-${task.id}`}
                  >

...
const STAGE_COLORS: Record<CaseStageCategory, string> = {
  all: 'text-muted',
  pre_review: 'text-[var(--accent)] bg-[var(--accent-soft)]',
  submitted: 'text-[var(--purple)] bg-[var(--purple-soft)]',
  os_condition: 'text-[var(--red)] bg-[var(--red-soft)]',
  approval: 'text-[var(--yellow)] bg-[var(--yellow-soft)]',
  settlement: 'text-[var(--green)] bg-[var(--green-soft)]',
};

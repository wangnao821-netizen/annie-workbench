...
export function NewTaskModal({ open, onClose, onOpenNewCase }: NewTaskModalProps) {
  ...
  return (
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[var(--bg-app)]/60 backdrop-blur-xs" id="new-task-modal-overlay">
        <motion.div
        ...
        >
          ...
          <div className="flex items-center justify-between pb-3 border-b" style={{ borderColor: 'var(--border)' }}>
            <div className="flex items-center space-x-2 text-sm font-bold" style={{ color: 'var(--text-primary)' }}>
              <ListPlus className="w-4 h-4 text-[var(--purple)]" />
          ...
          {/* Form / Guidance */}
          {cases.length === 0 ? (
            <div className="p-4 rounded-xl border bg-[var(--yellow-soft)] border-[var(--yellow-soft)] text-[var(--yellow)] text-xs space-y-3">
              <div className="flex items-center space-x-2 font-bold">
                <AlertCircle className="w-4 h-4 flex-shrink-0 text-[var(--yellow)]" />
              ...
              <button
                ...
                className="w-full py-2 rounded-xl text-xs font-bold text-white bg-[var(--yellow)] hover:bg-[var(--yellow)] flex items-center justify-center space-x-1.5 cursor-pointer shadow-xs"
              >
            ...
            <form onSubmit={handleSubmit} className="space-y-3.5 text-xs">
              {error && (
                <div className="p-2.5 rounded-xl border bg-[var(--red-soft)] border-[var(--red-soft)] text-[var(--red)] text-xs flex items-center space-x-1.5">
              ...
              <div className="space-y-1">
                <label className="font-bold text-[11px]" style={{ color: 'var(--text-secondary)' }}>
                  关联案件 <span className="text-[var(--red)]">*</span>
                </label>
                <select
                  id="newtask-case"
                  value={caseId}
              ...
              <div className="space-y-1">
                <label className="font-bold text-[11px]" style={{ color: 'var(--text-secondary)' }}>
                  任务标题 <span className="text-[var(--red)]">*</span>
                </label>
                <input
                  type="text"
                  id="newtask-title"
                  ...
                  className="w-full px-3 py-2 rounded-xl border outline-none font-medium bg-[var(--bg-subtle)]"

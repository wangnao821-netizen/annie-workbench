    ...
    >
      ...
      <div className="relative ml-4 flex-shrink-0" ref={menuRef}>
        <motion.button
          ...
          className="px-3.5 py-1.5 rounded-xl text-xs font-semibold flex items-center space-x-1.5 cursor-pointer shadow-sm flex-shrink-0"
          ...
          {menuOpen && (
            ...
            >
              <button
                ...
                className="w-full px-3 py-2 rounded-xl flex items-center space-x-2 text-left font-medium hover:bg-[var(--bg-subtle)] transition-colors cursor-pointer"
                style={{ color: 'var(--text-primary)' }}
              >
                <FolderPlus className="w-4 h-4 text-[var(--green)]" />
                <span>新建案件</span>
              </button>
              <button
                type="button"

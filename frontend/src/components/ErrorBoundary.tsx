  ...
  public render() {
    if (this.state.hasError) {
      return (
        ...
        >
          <div className="p-4 rounded-2xl bg-[var(--red-soft)] text-[var(--red)] mb-4">
            <AlertTriangle className="w-10 h-10" />
          </div>
          <h2 className="text-lg font-extrabold mb-2">页面出错了 (Application Error)</h2>
          <p className="text-xs text-muted max-w-md mb-6 font-mono bg-[var(--bg-subtle)] p-3 rounded-xl border border-[var(--red-soft)]">

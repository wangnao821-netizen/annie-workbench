        ...
        <div className="flex items-center justify-between flex-wrap gap-2">
          ...
          <div className="flex items-center space-x-2">
            ...
            <select
              ...
              className="px-2 py-1 rounded-lg border text-[11px] font-mono outline-none cursor-pointer"
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between flex-wrap gap-2">
        ...
        {item.aiConfidence && (
          <span className="text-[11px] font-mono font-semibold px-2 py-0.5 rounded" style={{ backgroundColor: 'var(--yellow-soft)', color: 'var(--yellow)' }}>
      ...
      <div className="flex items-center space-x-2 pt-1 pl-6 flex-wrap gap-2">
        <select
          ...
          className="px-2.5 py-1.5 rounded-xl border text-xs outline-none font-medium cursor-pointer"

    ...
    <div className="space-y-6" id="boss-decision-detail">
      ...
      <div className="rounded-2xl p-5 border space-y-4 shadow-2xs" style={{ backgroundColor: 'var(--bg-card)', borderColor: 'var(--border)' }}>
        <div className="flex items-center justify-between pb-2 border-b" style={{ borderColor: 'var(--border)' }}>
          ...
          <span className="text-xs font-mono px-2 py-0.5 rounded font-bold" style={{ backgroundColor: 'var(--yellow-soft)', color: 'var(--yellow)' }}>
            需要 Owner 批准
          </span>
        </div>
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex items-center space-x-2">
              <button
                ...
                className={`px-3 py-1.5 rounded-xl border text-xs font-semibold transition-all ${
                  decision === 'approve'
                    ...
                    : 'border-[var(--border)] dark:border-[var(--border)] hover:opacity-80'
                }`}
              >
                同意 (转批 CBA)
              </button>
              <button
                ...
                className={`px-3 py-1.5 rounded-xl border text-xs font-semibold transition-all ${
                  decision === 'reject'
                    ? 'bg-[var(--red-soft)] border-[var(--red)] text-[var(--red)] dark:text-[var(--red)]'
                    : 'border-[var(--border)] dark:border-[var(--border)] hover:opacity-80'
                }`}
              >
                拒绝
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-xl border text-xs font-semibold transition-all ${
                  decision === 'defer'
                    ? 'bg-[var(--yellow-soft)] border-[var(--yellow)] text-[var(--yellow)]'
                    : 'border-[var(--border)] dark:border-[var(--border)] hover:opacity-80'
                }`}
              >
                暂缓

...
export function CaseBoard({ onOpenCase, onViewAnalytics }: CaseBoardProps) {
  ...
  return (
    <div className="flex-1 flex flex-col h-full overflow-hidden p-6 space-y-5" id="case-board-page">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          ...
          <motion.button
            ...
            className="px-3.5 py-2 rounded-xl text-xs font-semibold flex items-center space-x-1.5 cursor-pointer shadow-xs"
      ...
      {casesError && (
        <div className="p-3 rounded-xl border border-[var(--red-soft)] bg-[var(--red-soft)] text-[var(--red)] flex items-center justify-between text-xs">
          <div className="flex items-center space-x-2">
          ...
          <button
            onClick={() => fetchCases()}
            className="flex items-center space-x-1 px-2.5 py-1 rounded-lg bg-[var(--red-soft)] hover:bg-[var(--red)]/30 font-medium transition-colors cursor-pointer"
          >

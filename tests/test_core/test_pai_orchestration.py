...
def test_tool_whitelist_matches_wo26():
    ...
    assert len(pai._TOOL_NAMES) == 12  # + WO-77 record_fact_find  # WO-27 draft_email + WO-32 folder_lookup + WO-33 gap_analysis + WO-41 task_create + WO-43 checklist_query/checklist_preview + WO-44 file_ops_open
